...
const HomePageFeatures = () => {
  return (
          ...
          <div className="flex flex-col justify-center items-center gap-4">
            ...
            <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-red-600">
              Models: 2.5LB, 4LB, 5LB, YT5L, 7, LB, 9 LB, YT9L, 14LB
            </h4>
            <div className="bg-red-600 w-2/12 h-[2px]" />
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 justify-start sm:justify-center gap-4 items-center py-4 lg:py-6 xl:py-10">
            <div className="flex flex-col gap-4 lg:gap-10">
              <div className="group flex flex-row justify-start items-center gap-4">
                <div className="bg-white rounded-full p-4 text-black transition-colors duration-300 group-hover:bg-red-600 group-hover:text-white">
                  <BsScrewdriver className="w-8 h-8 rounded-full" />
                </div>
                <div>
                  <h2 className="text-lg lg::text-xl font-bold group-hover:text-red-600">
                    KOREAN TECHNOLOGY
                  </h2>
            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="group flex flex-row lg:flex-row-reverse justify-start items-center gap-4">
                ...
                <div className="text-left lg:text-right">
                  <h2 className="text-lg lg::text-xl font-bold transition-colors duration-300 group-hover:text-red-600">
                    ECO-FRIENDLY
                  </h2>
                  <p className="text-sm text-slate-700">
